 ...
 *
 */
public class MySlowlyServiceImpl_AopProxy implements MySlowlyService {

	private static final Logger LOGGER = LoggerFactory.getLogger(MySlowlyServiceImpl_AopProxy.class);
